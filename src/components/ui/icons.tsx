...
export function CorruptIcon({ className }: { className?: string }) {
    return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function StaticIcon({ className }: { className?: string }) {
    return (
...
export function LockClosedIcon({ className, title }: { className?: string, title?: string }) {
    return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function VerifiedIcon({ className, title, style }: { className?: string, title?: string, style?: React.CSSProperties }) {
    return (
