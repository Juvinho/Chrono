                    ...
                    <div className="space-y-4">
                        <div className="relative h-48 w-full rounded-lg overflow-hidden border border-[var(--theme-border)] group">
                            {draftUser.profileSettings?.coverImage ? (
                                <img src={draftUser.profileSettings.coverImage.includes('data:') ? draftUser.profileSettings.coverImage : `${draftUser.profileSettings.coverImage}?t=${imageCacheBuster}`} alt="Cover" className="w-full h-full object-cover aspect-video" width={1200} height={480} key={`cover-${imageCacheBuster}`} />
                            ) : (
                        ...
                        <div className="mt-4">
                            ...
                            <div className="flex gap-2 overflow-x-auto pb-2 no-scrollbar">
                                {COVER_PRESETS.map((url, i) => (
                                    ...
                                    >
                                        <img src={url} alt={`${t('presetCovers')} ${i+1}`} className="w-full h-full object-cover aspect-video" width={80} height={48} />
                                    </button>
                                ))}
                            </div>
                        </div>
