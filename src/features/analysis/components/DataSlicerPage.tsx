...
export default function DataSlicerPage({
  user, onLogout, onNavigate, onNotificationClick, onViewNotifications, allUsers, allPosts, conversations, onOpenMarketplace, onOpenChat, onBack, lastViewedNotifications
}: DataSlicerPageProps) {
