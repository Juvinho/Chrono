    ...
    return (
        <header className="h-16 bg-[var(--theme-bg-primary)] border-b-2 border-[var(--theme-border-primary)] z-50 relative flex items-center justify-between px-6 flex-shrink-0">
            ...
            <div className="flex items-center space-x-4">
                 ...
                 <button onClick={() => onNavigate(Page.Messages)} title={t('directMessagesTitle')} className="relative text-[var(--theme-text-secondary)] hover:text-[var(--theme-secondary)] p-2 rounded-full hover:bg-[var(--theme-bg-tertiary)] transition-colors">
